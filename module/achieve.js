...
module.exports = (loginUserEmail, score, gameType = '2048') => {
  return new Promise(async (resolve, reject) => {
    ...
    try {
      ...
      //SELECT user achieve
      const selectUserAchSql =
        'SELECT user_achieve_tb.achieve_idx FROM user_achieve_tb LEFT JOIN achieve_tb ON user_achieve_tb.achieve_idx = achieve_tb.achieve_idx  WHERE user_email = $1 AND game_type = $2';
      ...
      const selectPlayCountSql =
        'SELECT game_2048_count, game_tetris_count FROM user_tb WHERE email = $1';
